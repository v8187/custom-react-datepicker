...
interface propTypes {
  ...
  startDate?: Date,
  renderDayContents?: (date, day) => any,
  handleOnKeyDown?: (event?) => any,
  containerRef;
  excludeDates?
};

export default class Day extends React.Component<propTypes, any> {


  componentDidMount() {
    this.handleFocusDay(this.props);
  }
  ...
  isExcluded = () => {
    return isDayExcluded(this.props.day, this.props);
  }
